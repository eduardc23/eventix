...
void main() {
  ...
  group('BookingListBody - Estados de la Interfaz', () {
    testWidgets('Muestra el indicador de carga al iniciar la obtención de datos', (tester) async {
    ...
    testWidgets('Visualiza el estado de error cuando la carga de reservas falla', (
        tester,
        ) async {
      when(
            () => mockUseCase(any()),
  ...
  group('BookingListBody - Organización de Contenido', () {
    testWidgets('Divide y presenta las reservas en secciones de próximas y pasadas', (
        tester,
        ) async {
